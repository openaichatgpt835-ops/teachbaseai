...
export const UPGRADE_COPY = {
  ...
  flowBuilder: {
    ...
    text: "Сценарии для внешнего клиентского канала доступны на старших тарифах.",
    description:
      "Конструктор нужен, когда надо собирать маршруты общения с клиентом: вопросы, ветвления, ответы по базе знаний, CRM-действия и handoff в оператора.",
    bullets: [
      "Сценарии клиента поверх базы знаний",
      "Intent-ветвления и handoff в оператора",
      "Webhook-ноды и действия в CRM",
    ],
    previewTitle: "Сценарии и автоматизация",
  },
  webhookNodes: {
    title: "Webhook-ноды",
